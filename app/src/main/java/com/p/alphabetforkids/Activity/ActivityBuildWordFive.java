...
public class ActivityBuildWordFive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_build_word_five);
        ...
        txtLevelOne.setText(" = جَمع");
        txtLevelTwo.setText(" = دِفاع");
    ...
    public void onClickMethod() {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaOk(R.raw.click);
                Intent intent = new Intent(ActivityBuildWordFive.this, ActivityAllAlphabet.class);
    ...
    private void mediaOk(int p) {
        mediaPlayer = MediaPlayer.create(ActivityBuildWordFive.this, p);
        mediaPlayer.start();
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mp) {
    ...
    private void settingForDropAndDrags(View v, View view) {
        ...
        } else if (view.getId() == R.id.option6 && v.getId() == R.id.lnr10) {
