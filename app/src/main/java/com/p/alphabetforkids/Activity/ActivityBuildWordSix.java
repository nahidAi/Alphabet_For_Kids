...
public class ActivityBuildWordSix extends AppCompatActivity {
    View view;
    private int myId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_build_word_six);
        ...
        txtLevelOne.setText(" = تیغ");
        txtLevelTwo.setText(" = چِراغ");
    ...
    public void onClickMethod() {
        audioLevelOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(ActivityBuildWordSix.this,R.raw.tigh);
                mediaPlayer.start();
        ...
        audioLevelTwo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(ActivityBuildWordSix.this,R.raw.cheragh);
                mediaPlayer.start();
                mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mp) {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaOk(R.raw.click);
                Intent intent = new Intent(ActivityBuildWordSix.this, ActivityAllAlphabet.class);
    ...
    private void mediaOk(int p) {
        mediaPlayer = MediaPlayer.create(ActivityBuildWordSix.this, p);
        mediaPlayer.start();
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mp) {
