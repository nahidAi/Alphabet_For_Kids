...
public class ActivityBuildWordThree extends AppCompatActivity {
    View view;
    private int myId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_build_word_three);
        ...
        txtLevelOne.setText(" = تابه");
        txtLevelTwo.setText(" = نَرده");
    ...
    public void onClickMethod() {
        audioLevelOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(ActivityBuildWordThree.this,R.raw.tabe);
                mediaPlayer.start();
        ...
        audioLevelTwo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(ActivityBuildWordThree.this,R.raw.narde);
                mediaPlayer.start();
                mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mp) {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaOk(R.raw.click);
                Intent intent = new Intent(ActivityBuildWordThree.this, ActivityAllAlphabet.class);
    ...
    private void mediaOk(int p) {
        mediaPlayer = MediaPlayer.create(ActivityBuildWordThree.this, p);
        mediaPlayer.start();
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mp) {
    ...
    private void settingForDropAndDrags(View v, View view) {
        if (view.getId() == R.id.option8 && v.getId() == R.id.lnr1) {
        ...
        } else if (view.getId() == R.id.option1 && v.getId() == R.id.lnr2) {
