...
public class ActivityBuildWordFour extends AppCompatActivity {
    View view;
    private int myId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_build_word_four);
        ...
        txtLevelOne.setText(" = نُه");
        txtLevelTwo.setText(" = ماه");
    ...
    public void onClickMethod() {
        audioLevelOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(ActivityBuildWordFour.this,R.raw.noh);
                mediaPlayer.start();
        ...
        audioLevelTwo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(ActivityBuildWordFour.this,R.raw.mah);
                mediaPlayer.start();
                mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mp) {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaOk(R.raw.click);
                Intent intent = new Intent(ActivityBuildWordFour.this, ActivityAllAlphabet.class);
    ...
    private void mediaOk(int p) {
        mediaPlayer = MediaPlayer.create(ActivityBuildWordFour.this, p);
        mediaPlayer.start();
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mp) {
